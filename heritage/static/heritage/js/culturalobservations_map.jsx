...
ReactDOM.render(
    <LeafletMap width="auto" height="500px" settings={map_settings} map_id={culturalobservations_map_id} callback={get_data_build_map} />,
    document.getElementById(culturalobservations_map_id)
);
