...
#####################################################
# Hay-hacked Solr Backend - based on assets.search_backend:
#####################################################
...
class CustomSearchQuerySet(SearchQuerySet):
    """
    Customized Search Queryset that works with CustomSolrSearchQuery & CustomSolrBackend
    to provide parameterized highlighting.
    """
