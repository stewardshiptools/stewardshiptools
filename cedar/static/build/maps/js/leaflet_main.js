...
var LeafletMap = React.createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        // Add base layers.
        var create_base_layer = function create_base_layer(layer_settings) {
            var layer = false;
        ...
        var layerSwitcher = L.control.layers(base_layers, overlay_layers, { 'collapsed': this.props.settings.layer_control_collapsed });
    ...
    render: function render() {
        return React.createElement('div', { id: this.props.map_id, style: { width: this.props.width, height: this.props.height } });
    }
});
...
if (leaflet_settings) {
    $.each(leaflet_settings, function (machine_name, map_url) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            cache: false,
            success: function success(map_settings) {
                ReactDOM.render(React.createElement(LeafletMap, { width: 'auto', height: '500px', settings: map_settings }), document.getElementById(machine_name));
            },
