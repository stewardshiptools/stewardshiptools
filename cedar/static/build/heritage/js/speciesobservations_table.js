...
GridSettings = React.createClass({
    ...
    render: function render() {
        ...
        if (that.props.useCustomComponent === false) {
            nodes = this.props.columns.map(function (col, index) {
                ...
                if (typeof meta !== "undefined" && meta != null && meta.locked) {
                    return React.createElement("div", { className: "column checkbox" }, React.createElement("label", null, React.createElement("input", { type: "checkbox", disabled: true, name: "check", checked: checked,
                        "data-name": col }), displayName));
                } else if (typeof meta !== "undefined" && meta != null && typeof meta.visible !== "undefined" && meta.visible === false) {
                    return null;
                }
                return React.createElement("div", { className: "griddle-column-selection checkbox", key: col,
                    style: that.props.useGriddleStyles ? { "float": "left", width: "20%" } : null }, React.createElement("label", null, React.createElement("input", { type: "checkbox", name: "check",
        ...
        var toggleCustom = that.props.enableToggleCustom ? React.createElement("div", { className: "form-group" }, React.createElement("label", { htmlFor: "maxRows" }, React.createElement("input", { type: "checkbox", checked: this.props.useCustomComponent,
            onChange: this.props.toggleCustomComponent }), " ", this.props.enableCustomFormatText)) : "";
        ...
        return React.createElement("div", { className: "griddle-settings",
            style: this.props.useGriddleStyles ? { backgroundColor: "#FFF", border: "1px solid #DDD", color: "#222", padding: "10px", marginBottom: "10px" } : null }, React.createElement("h6", null, this.props.settingsText), React.createElement("div", { className: "griddle-columns",
            style: this.props.useGriddleStyles ? { clear: "both", display: "table", width: "100%", borderBottom: "1px solid #EDEDED", marginBottom: "10px" } : null }, nodes), setPageSize, toggleCustom);
    }
});
...
var SpeciesObservationsComponent = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement("div", null, React.createElement("div", { className: "extra-tight-table-row teal-text text-darken-2 col s12" }, "Note: The Species Records table and map are linked. Filter the table and the map will update correspondingly."), React.createElement("div", { className: "extra-tight-table-row grey-text text-darken-2 col s12", style: { fontWeight: "bold" } }, React.createElement("div", { id: "species-inline-results-count-prefix", style: { display: "inline" } }), React.createElement("div", { id: "species-inline-results-count", style: { display: "inline" } })), React.createElement("div", { className: "row" }, results_on_page_selector, React.createElement("div", { className: "col s12" }, React.createElement(Griddle, { useExternal: true, externalSetPage: this.setPage,
