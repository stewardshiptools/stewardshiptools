...
var Project = React.createClass({
    ...
    render: function render() {
        ...
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-code' }, this.props.data.cedar_project_code));

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-start-date' }, this.props.data.start_date));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-end-date' }, this.props.data.end_date));
...
var ProjectList = React.createClass({
    ...
    render: function render() {
        ...
        headers.push(React.createElement('th', { key: 'start-date', 'data-field': 'start_date' }, 'Start date'));
        headers.push(React.createElement('th', { key: 'end-date', 'data-field': 'end_date' }, 'End date'));
...
var sort_field_options = [['id', 'ID'], ['cedar_project_name', 'Name'], ['start_date', 'Start date'], ['end_date', 'End date']];
