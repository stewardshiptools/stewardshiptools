...
var Report = React.createClass({
    ...
    render: function render() {
        var report_on_nodes = this.props.data.report_on.map(function (layer, key) {
            return React.createElement('li', { key: key }, React.createElement('a', { href: layer.url }, layer.name));
        });

        return React.createElement('tr', null, React.createElement('td', { className: 'extra-tight-table-row' }, React.createElement('a', { href: this.props.data.url }, this.props.data.name)), React.createElement('td', { className: 'extra-tight-table-row' }, this.props.data.distance_cap), React.createElement('td', { className: 'extra-tight-table-row' }, React.createElement('ul', null, report_on_nodes)));
    }
});
...
var ReportList = React.createClass({
    ...
    render: function render() {
        var reportNodes = this.props.data.map(function (report) {
            return React.createElement(Report, { key: report.url, data: report });
        });

        return React.createElement('div', { className: 'reportList' }, React.createElement('table', { className: '' }, React.createElement('thead', null, React.createElement('tr', null, React.createElement('th', { 'data-field': 'name' }, 'Name'), React.createElement('th', { 'data-field': 'distance_cap' }, 'Default distance cap'), React.createElement('th', { 'data-field': 'report_on' }, 'Report on items'))), React.createElement('tbody', null, reportNodes)));
    }
});

var ReportPager = React.createClass({
    displayName: 'ReportPager',
...
var ReportBox = React.createClass({
    ...
    render: function render() {
        ...
        if (this.props.showPager) {
            pager = React.createElement(ReportPager, {
        ...
        if (this.props.showSearch) {
            search = React.createElement(ReportSearch, { handleSearch: this.handleSearch });
        }

        return React.createElement('div', { className: 'reportBox' }, search, pager, React.createElement(ReportList, { data: this.state.data }), pager);
    }
});

ReactDOM.render(React.createElement(ReportBox, { url: geoinfo_report_list_ajax_url,
    showPager: geoinfo_report_list_show_pager,
    showSearch: geoinfo_report_list_show_search }), document.getElementById(geoinfo_report_list_attach_id));
