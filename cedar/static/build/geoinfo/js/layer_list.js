...
var Layer = React.createClass({
    ...
    render: function render() {
        ...
        var columns = [];
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-name' }, React.createElement('a', { href: this.props.data.url }, this.props.data.name)));

        if (this.props.data.layer_type) {
            columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-layer_type' }, this.props.data.layer_type));
        }

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-feature_count' }, this.props.data.feature_count));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-author' }, this.props.data.author));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-created' }, this.props.data.created));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-notes' }, this.props.data.notes));
...
var LayerList = React.createClass({
    ...
    render: function render() {
        var layerNodes = this.props.data.map(function (layer) {
            return React.createElement(Layer, { key: layer.id, data: layer });
        });
        ...
        headers.push(React.createElement('th', { key: 'name', 'data-field': 'name' }, 'Name'));

        if (show_type) {
            headers.push(React.createElement('th', { key: 'type', 'data-field': 'type' }, 'Type'));
        }

        headers.push(React.createElement('th', { key: 'feature_count', 'data-field': 'feature_count' }, '# Features'));
        headers.push(React.createElement('th', { key: 'author', 'data-field': 'author' }, 'Created By'));
        headers.push(React.createElement('th', { key: 'created', 'data-field': 'created' }, 'Created Date'));
        headers.push(React.createElement('th', { key: 'notes', 'data-field': 'notes' }, 'Description'));

        return React.createElement('div', { className: 'layerList' }, React.createElement('table', { className: '' }, React.createElement('thead', null, React.createElement('tr', null, headers)), React.createElement('tbody', null, layerNodes)));
    }
});

var LayerPager = React.createClass({
    displayName: 'LayerPager',
...
var LayerSearch = React.createClass({
    ...
    render: function render() {
        return React.createElement('div', { className: 'input-field col s12 m8 l4' }, React.createElement('i', { className: 'material-icons prefix' }, 'search'), React.createElement('input', { type: 'text', id: 'search_box' }), React.createElement('label', { htmlFor: 'search_box' }, 'Filter'));
    },
...
var LayerTypeFilter = React.createClass({
    displayName: 'LayerTypeFilter',

    handleLayerFilterEvent: function handleLayerFilterEvent(e) {
    ...
    render: function render() {
        var layer_type_options = this.props.layerTypes.map(function (option) {
            ...
            var val = option[key];
            return React.createElement('option', { key: key, value: val }, key);
        });
        return React.createElement('div', { id: 'layer-type-filter-select', className: 'input-field col s12 m4 l3' }, React.createElement('select', { value: this.props.currentType, onChange: this.handleLayerFilterEvent }, layer_type_options), React.createElement('label', null, 'Layer type'));
    }
});

var LayerBox = React.createClass({
    displayName: 'LayerBox',
    ...
    loadLayerData: function loadLayerData() {
    ...
    setLayerType: function setLayerType(type) {
        this.setState({
            layerType: type
        }, this.loadLayerData);
    },
    render: function render() {
        ...
        if (this.props.showPager) {
            pager = React.createElement(LayerPager, {
        ...
        if (geoinfo_layer_types) {
            layer_type_select = React.createElement(LayerTypeFilter, {
        ...
        if (this.props.showSearch) {
            search = React.createElement(LayerSearch, { handleSearch: this.handleSearch });
        }

        return React.createElement('div', { className: 'layerBox' }, React.createElement('div', { className: 'row' }, search, layer_type_select), pager, React.createElement(LayerList, { data: this.state.data }), pager);
    }
});

ReactDOM.render(React.createElement(LayerBox, { url: geoinfo_layer_list_ajax_url,
