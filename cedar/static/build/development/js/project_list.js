...
var Project = React.createClass({
    ...
    render: function render() {
        ...
        if (this.props.data.status == 'active') {
            status = React.createElement('span', { className: 'badge cedar-badge green white-text' }, 'Active');
        } else if (this.props.data.status == 'inactive') {
            status = React.createElement('span', { className: 'badge cedar-badge grey darken-3 white-text' }, 'Inactive');
        } else {
        ...
        if (this.props.data.initial_date) {
            dates.push(React.createElement('span', { style: nowrap_style }, React.createElement('em', null, this.props.data.initial_date)));
        }
        if (this.props.data.due_date) {
            dates.push(React.createElement('span', { style: nowrap_style }, React.createElement('strong', null, this.props.data.due_date)));
        }

        var dates_string = dates.map(function (item, i) {
            return [item, React.createElement('br', { key: i + '-date-' + 'br' })];
        });

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-name' }, React.createElement('a', { href: this.props.data.url }, this.props.data.cedar_project_name)));

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-dates' }, dates_string));

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-code' }, React.createElement('span', { style: nowrap_style }, this.props.data.cedar_project_code)));

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-status' }, status));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-filing-code' }, this.props.data.filing_code));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-company' }, this.props.data.company));

        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-num-files' }, this.props.data.num_files));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-num-comms' }, this.props.data.num_comms));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-num-comments' }, this.props.data.num_comments));
        columns.push(React.createElement('td', { className: 'extra-tight-table-row', key: this.props.data.id + '-file-numbers' }, this.props.data.file_numbers.join(', ')));
...
var ProjectList = React.createClass({
    ...
    render: function render() {
        ...
        headers.push(React.createElement('th', { key: 'name', 'data-field': 'cedar_project_name' }, 'Name'));
        headers.push(React.createElement('th', { key: 'dates', 'data-field': 'cedar_project_dates' }, 'Dates'));
        headers.push(React.createElement('th', { key: 'code', 'data-field': 'cedar_project_code' }, 'Harvest Code'));
        headers.push(React.createElement('th', { key: 'status', 'data-field': 'status' }, 'Status'));
        headers.push(React.createElement('th', { key: 'filing_code', 'data-field': 'filing_code' }, 'Filing Code'));
        headers.push(React.createElement('th', { key: 'company', 'data-field': 'company' }, 'Company'));

        headers.push(React.createElement('th', { key: 'num_files', 'data-field': 'num_files' }, 'Files'));
        headers.push(React.createElement('th', { key: 'num_comms', 'data-field': 'num_comms' }, 'Comm.'));
        headers.push(React.createElement('th', { key: 'num_comments', 'data-field': 'num_comments' }, 'Disc.'));
        headers.push(React.createElement('th', { key: 'file_numbers', 'data-field': 'file_numbers' }, 'File Numbers'));

        return React.createElement('div', { className: 'projectList' }, React.createElement('table', { className: '' }, React.createElement('thead', null, React.createElement('tr', null, headers)), React.createElement('tbody', null, projectNodes)));
    }
});

var reset_event = "CedarListResetState";

var page_size_options = [5, 10, 25, 50, 100, 500, 1000];

var sort_field_options = [['id', 'Project ID'], ['cedar_project_name', 'Name'], ['initial_date_null,initial_date', 'Initial date'], ['due_date_null,due_date', 'Due date'], ['status', 'Status'], ['filing_code__code', 'Filing code'], ['company__name', 'Company']];
