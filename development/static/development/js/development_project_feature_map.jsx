...
make_layer_switcher_layer_text = function (layer) {
    var edit_url = layer.cedar_properties.edit_url;
    var delete_url = layer.cedar_properties.delete_url;

    var s_text = '<span> ' + layer.cedar_properties.layer_name +
        '<a class="waves-grey lighten-5 grey-text text-darken-1 tooltipped-maps" href="' + delete_url +
        '" data-tooltip="Delete Layer" data-position="bottom">' +
        '<span class="right">' +
        '<i class="material-icons" style="font-size:inherit;">delete</i>' +
        '</span>' +
        '</a>' +
        '</span>' +
        '<a class="waves-grey lighten-5 grey-text text-darken-1 tooltipped-maps" href="' + edit_url +
        '" data-tooltip="Edit Layer" data-position="left">' +
        '<span class="right">' +
...
post_build = function (map) {
    ...
    var create_layer_button = '<a class="leaflet-control-zoom-out tooltipped-maps-create-layer" href="' + create_url +
        '" data-tooltip="Add New Layer" data-position="right"> ' +
        '<i class="material-icons" style="font-size:inherit;">add_location</i>' +
        '</a>'
